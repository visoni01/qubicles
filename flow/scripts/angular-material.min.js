...
var flowApp = angular.module('FeneroFlowApp', ['ngMaterial','ngMessages','ngRoute','mdPickers','checklist-model']);
...
flowApp.config(function($routeProvider, $locationProvider, $anchorScrollProvider, $mdThemingProvider) {
    ...
    $routeProvider
        ...
        .when('/Flow', {
            templateUrl : '../public/templates.views.home.html',
            controller  : 'HomeCtrl',
        ...
        .when('/Flow/editor/:flowId/:userId/:leadId/:listId', {
            templateUrl : '../public/templates.views.editor.html',
            controller  : 'FlowCtrl',
        ...
        .when('/Flow/view/:flowId/:userId/:leadId/:listId', {
            templateUrl : '../public/templates.views.render.html',
            controller  : 'FlowCtrl',
            controllerAs : 'flowController'
        })
...
flowApp.factory('baseUrlService', function($location){
    ...
    factory.base = function(){
        ...
        return `${$location.host()}:4000/api/v1/flows`;
    };
    return factory;
});
...
flowApp.service('dataService', function($http, baseUrlService){
    ...
    this.getFlowPages = function (flow_id, user_id){
        return $http({
            url: baseUrlService.base() + `/pages/${flow_id}`,
            method:"GET",
    ...
    this.getFlowFields = function (flow_id){
        return $http({
            url: baseUrlService.base() + `/fields/${flow_id}`,
            method:"GET",
    ...
    this.deleteFlowField = function(field_id){
        return $http({
            url: baseUrlService.base() + `/field/delete/${field_id}`,
            method:"POST",
    ...
    this.getLead = function (lead_id, list_id, user_id, flow_id, is_preview){
        return $http({
            url: baseUrlService.base() + "/Flow/GetLead",
            method:"GET",
...
flowApp.controller('HomeCtrl', function($scope, $mdDialog, $location, dataService, pagerService) {
    ...
    homeController.addFlow = function (){
        $mdDialog.show({
          ...
          templateUrl: '../public/templates.views.flow.edit.html',
    ...
    homeController.deleteFlow = function (flow_id){
        $mdDialog.show({
          ...
          templateUrl: '../public/templates.views.delete.dialog.html',
          parent: angular.element(document.body),
          clickOutsideToClose:true
        })
        .then(function(field) {
...
flowApp.directive('controlSharedConfig', function($compile) {
    return {
        ...
        templateUrl: '../public/templates.control.settings.html',
        link: function(scope, element, attrs) {
        ...
        controller: function($scope) {
            ...
            $scope.getTemplateUrl = function() {
                ...
                if (controlType.length > 0){
                    var templateUrl = '../public/templates.control.config.'+controlType+'.html';
                    return templateUrl;
                } else {
                    return '';
                }
    ...
    return {
        ...
        controller: function($scope) {
            ...
            $scope.getTemplateUrl = function() {
                ...
                if (controlType.length > 0){
                    var templateUrl = '../public/templates.control.preview.'+controlType+'.html';
                    return templateUrl;
                } else {
                    return '';
                }
...
flowApp.controller('FlowCtrl', function ($scope, $log, $mdDialog, $mdMedia, 
    ...
    flowController.showControlConfig = function(ev, fieldInternalId) {
        ...
        $mdDialog.show({
          ...
          templateUrl: '../public/templates.control.settings.dialog.html',
          parent: angular.element(document.body),
          targetEvent: ev,
    ...
    flowController.editPageInfo = function(){
        ...
        $mdDialog.show({
          ...
          templateUrl: '../public/templates.views.flowpage.edit.html',
          parent: angular.element(document.body),
          clickOutsideToClose:true
        })
        .then(function(page) {
    ...
    flowController.controls = [
        {
            ...
            type: 'Action',
            imageUrl: "images/ctl_action.png",
            visible: true,
        ...
        },
        {
            ...
            type: 'Checkbox',
            imageUrl: "images/ctl_checkbox.png",
            visible: true,
        ...
        },
        {
            ...
            type: 'Textarea',
            imageUrl: "images/ctl_textarea.png",
            visible: true,
            showNavigationOpts: false,
            showValidationOpts: true
        },
        {
            ...
            type: 'Condition',
            imageUrl: "images/ctl_conditional.png",
            visible: true,
            showNavigationOpts: false,
            showValidationOpts: false
        },
        ...
        },
        {
            ...
            type: 'Dropdown',
            imageUrl: "images/ctl_dropdown.png",
            visible: true,
            showNavigationOpts: false,
            showValidationOpts: true
        },
        ...
        },
        {
            ...
            type: 'Calculation',
            imageUrl: "images/ctl_calculation.png",
            visible: true,
            showNavigationOpts: false,
            showValidationOpts: false
        },
        ...
        },
        {
            ...
            type: 'Multiselection',
            imageUrl: "images/ctl_multiselect.png",
            visible: true,
            showNavigationOpts: false,
            showValidationOpts: true
        },
        {
            ...
            type: 'Navigation',
            imageUrl: "images/ctl_navigation.png",
            visible: true,
            showNavigationOpts: true,
            showValidationOpts: false
        },
        {
            ...
            type: 'Radiobutton',
            imageUrl: "images/ctl_radiobutton.png",
            visible: true,
            showNavigationOpts: false,
            showValidationOpts: true
        },
        {
            ...
            type: 'Script',
            imageUrl: "images/ctl_scripttext.png",
            visible: true,
            showNavigationOpts: false,
            showValidationOpts: false
        },
        {
            ...
            type: 'Textfield',
            imageUrl: "images/ctl_textbox.png",
            visible: true,
            showNavigationOpts: false,
            showValidationOpts: true
        },
                ...
                if (actionDefault && actionDefault.length > 0){
                    ...
                    dataService.getDispositions(flowController.userId,flowController.listId, $scope["queue_id"])
                        ...
                        $mdDialog.show({
                          ...
                          templateUrl: '../public/templates.views.disposition.dialog.html',
                          parent: angular.element(document.body),
                          clickOutsideToClose:true
                        })
                        .then(function(field) {
            ...
            case "SENDEMAIL":
                ...
                if (email_opts && email_opts.length > 0 && email_opts[0] != 'undefined'){
                    ...
                    $mdDialog.show({
                      ...
                      templateUrl: '../public/templates.views.emailtemplate.dialog.html',
                      parent: angular.element(document.body),
                      clickOutsideToClose:true
                    })
                    .then(function(field) {
            ...
            case "XFERCALL":
                ...
                if (xfer_opts && xfer_opts.length > 0 && xfer_opts[0] != 'undefined' && xfer_opts[1] != 'undefined'){
                    ...
                    $mdDialog.show({
                      ...
                      templateUrl: '../public/templates.views.xfertemplate.dialog.html',
                      parent: angular.element(document.body),
                      clickOutsideToClose:true
                    })
                    .then(function(field) {
                        ...
                        if (field.field_type == "ACTION"){
                            ...
                            if (field.field_options=='HOUSEHOLD' && field.field_default){
                                ...
                                if (household_opts.length > 1){
                                    ...
                                    formOutput += "<img style=\"width:88px;height:88px;\" ng-src=\"images/navigation/thumb-users.png\" class=\"md-avatar\" alt=\"{{lead.phoneNumber}}\" />";
