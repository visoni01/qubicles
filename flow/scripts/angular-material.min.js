 ...
 * @license
 *                                      Qubicles Flow
 *                              Copyright 2016. Qubicles, Inc.
 *                                   All rights reserved.
 *                                    by: Marlon Williams
 *
 * NOTICE:  All information contained herein is, and remains the property of Qubicles Inc.
 * The intellectual and technical concepts contained herein are proprietary to Qubicles Inc
  ...
  this.performAction = function(action, value, user_id, scope, fields, lead_id, page_id, goToPause){
      ...
      if (scope && fields) {
          ...
          return $http({
              ...
              method:"POST",
              data:{userId: user_id, action:action, value: value,leadData:leadData,leadId:lead_id,pageId:page_id,goToPause:goToPause}
          });
      } else {
                          ...
                          if (fieldCheck && (leftOperand == fieldCheck.field_label)) {
                              ...
                              if (fieldCheck.field_type != "DATEPICKER" &&
                                  ...
                                  if (!Array.isArray(leftOperandLCase))
                                      leftOperandLCase = leftOperandLCase.toString().toLowerCase();
                              }
  ...
  flowController.executeAction = function(action, nextPageId, actionDefault){
      switch(action){
          ...
          case "NEWLEAD":
              ...
              dataService.performAction(action, flowController.leadId, flowController.userId, $scope, flowController.fields, flowController.leadId)
                  .then(function(response){
