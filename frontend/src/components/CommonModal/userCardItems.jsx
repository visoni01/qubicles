...
const UserCardItems = ({
  itemHeading, itemPic, itemRating, itemLink, itemRoute, itemSubHeading,
}) => (
  <div className='top-talent list-divider'>
    <div className='display-inline-flex mb-10'>
      ...
      <div className='candidate-info'>
        ...
        <p className='para light'>{itemSubHeading}</p>

        <span className='primary-text-link'>
          <Link to={ itemRoute }>{itemLink}</Link>
        </span>
      </div>
    </div>
  </div>
