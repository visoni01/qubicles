...
const PublishedCourseCard = ({
  enrolledThisMonth, totalEarned, testEntries, courseId, price, rating, studentsCount, title, sectionsCount, language,
  thumbnailImage, creatorName, ratingsCount,
}) => {
    ...
    <Grid xl={ 3 } lg={ 3 } md={ 6 } sm={ 12 } item>
      <Card className='course-card'>
        ...
        <CardContent className='course-card-content border-1'>
          ...
          <p className='para light description'>{creatorName}</p>
