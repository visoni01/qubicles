...
export const jobDetailsPropTypes = PropTypes.shape({
  ...
  durationMonths: PropTypes.oneOfType([ PropTypes.number, PropTypes.string ]),
  experienceType: PropTypes.string,
  locationType: PropTypes.string,
  payAmount: PropTypes.oneOfType([ PropTypes.number, PropTypes.string ]),
  languages: PropTypes.string,
  city: PropTypes.string,
  state: PropTypes.string,
  country: PropTypes.string,
  fulfilled: PropTypes.number,
  needed: PropTypes.oneOfType([ PropTypes.number, PropTypes.string ]),
  pending: PropTypes.number,
  evaluating: PropTypes.number,
