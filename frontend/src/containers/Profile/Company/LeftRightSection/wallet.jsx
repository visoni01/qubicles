    ...
    <Grid container>
      <Grid item container justify='space-between' spacing={ 3 }>
        ...
        <Grid item xl={ 4 } lg={ 4 } sm={ 4 } xs={ 4 }>
          <div>
            <p className='para price-green'> 12 QBE </p>
            <p className='para'> $12 USD </p>
          </div>
        </Grid>
      </Grid>
