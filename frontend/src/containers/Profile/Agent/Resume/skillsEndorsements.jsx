...
import {
  skills, languages, agentResumeSkills, agentResumeLanguages,
} from './mockData'

import EditSkills from '../../../People/ContactCenter/Talent/Application/editSkills'
  ...
  return (
    <>
      ...
      <EditSkills
        ...
        languages={ agentResumeLanguages }
      />
    </>
  )
}
