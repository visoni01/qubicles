...
import ContactCenterSkeleton from '../SkeletonLoader/ContactCenterSkeleton'
...
const ContactCenterIntro = ({ jobDetails }) => {
  ...
  const { companyDetails, success, isLoading } = useSelector((state) => state.jobPostCompanyDetails)
