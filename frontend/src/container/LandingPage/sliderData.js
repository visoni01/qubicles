const sliderData = [
  {
    ...
    detail: `Where talented customer service, sales and support agents
  ...
  },
  {
    ...
    detail: `Welcome to the future - where you are the boss with a more flexible schedule and working
  ...
  },
  {
    ...
    detail: `We utilize blockchain technology to create a unique reward-based economy,
  ...
  },
  {
    ...
    detail: `Designed to meet the needs of small, mid-sized, and enterprise contact centers alike, we scale as your
      business grows.`,
    buttonName: 'Sign Up for Free',
